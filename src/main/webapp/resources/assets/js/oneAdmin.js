...
oneS = {
  adminGnb : function(){
    ...
    $('.widthChange').on('click', function(){
     ...
     $('.widthChange_opacity').on('click', function(){
      oneS.adminGnb.layout > 0 ? oneS.adminGnb.layout-- : oneS.adminGnb.layout = 0;
      $(".adminContetLayout").attr("class","adminContetLayout on"+oneS.adminGnb.layout);
    });
    
    
    $('.widthChange_opacity').hover(function(){
        $('.widthChange').addClass('widthChangeHover');
    }, function() {
        $('.widthChange').removeClass('widthChangeHover');
    });
    ...
    $('.widthChange2_opacity').on('click', function(){
      oneS.adminGnb.layout > 1 ? oneS.adminGnb.layout = 2 : oneS.adminGnb.layout++;
      $(".adminContetLayout").attr("class","adminContetLayout on"+oneS.adminGnb.layout);
    });
    
   $('.widthChange2_opacity').hover(function(){
        $('.widthChange2').addClass('widthChange2Hover');
    }, function() {
        $('.widthChange2').removeClass('widthChange2Hover');
    });
    ...
    $(".gnb > li > a").on("mouseenter",function(){
	  ...
	  $(this).next(".subMenuBox2").slideDown();
	  $(this).next(".subMenuBox3").slideDown();
	  $(this).next(".subMenuBox4").slideDown();
	  $(this).parent().addClass("on");
    });
    $(".gnb > li").on("mouseleave",function(){
      $(this).find(".subMenuBox").stop().slideUp(200);
      $(this).find(".subMenuBox2").stop().slideUp(200);
      $(this).find(".subMenuBox3").stop().slideUp(200);
      $(this).find(".subMenuBox4").stop().slideUp(200);
      $(this).removeClass("on");
    });
  },
  form : function(){//form
