...
(function(global) {
    ...
    (function() {
        ...
        qq.FineUploaderBasic = function(o) {
            ...
            this._options = {
                ...
                messages: {
                    typeError: "{file} 확장자는 업로드 하실 수 없습니다. 가능한 확장자: {extensions}.",
                    sizeError: "{file} 용량이 허용 한계를 초과합니다, 최대 등록 파일 사이즈는 {sizeLimit} 입니다.",
                    minSizeError: "{file} 용량이 너무 작습니다, 최소 등록 파일 사이즈는 {minSizeLimit} 입니다.",
                    emptyError: "{file} 은 빈 파일 입니다, 다시 선택하십시오.",
    ...
    qq.FineUploader = function(o, namespace) {
        ...
        qq.extend(this._options, {
            ...
            deleteFile: {
                forceConfirm: false,
                confirmMessage: "{filename} 을 삭제하시겠습니까?",
                deletingStatusText: "삭제중...",
                deletingFailedText: "삭제 실패.."
            },
            display: {
