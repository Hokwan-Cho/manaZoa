...
public class EgovStringUtil {
	...
	public static String nullConvert(Object src, String defaultValue) {
		//if (src != null && src.getClass().getName().equals("java.math.BigDecimal")) {
		if (src != null && src instanceof java.math.BigDecimal) {
			return ((BigDecimal) src).toString();
		}
	...
	public static String nullConvert(String src, String defaultValue) {
	...
	public static String br2nl(String string) {
        return (string != null) ? string.replace("<br/>", "\r\n") : null;
    }
